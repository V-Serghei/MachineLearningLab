...
save_figure("adaboost_target_dist")
plt.show()
...
save_figure("adaboost_corr_matrix")
plt.show()
...
save_figure("adaboost_feat_hist")
plt.show()
...
save_figure("adaboost_feat_importance")
plt.show()
